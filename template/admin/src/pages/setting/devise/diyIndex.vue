<template>
  <div class="diy-page">
    <div class="i-layout-page-header header-title">
      <div class="fl_header">
        <span class="ivu-page-header-title mr20"
              style="padding: 0"
              v-text="$route.meta.title"></span>
        <div class="rbtn">
          <el-button class="ml20 header-btn look"
                     @click="preview"
                     :loading="loading">预览</el-button>
          <el-button class="ml20 header-btn close"
                     @click="closeWindow"
                     :loading="loading">关闭</el-button>
          <el-button class="ml20 header-btn save"
                     @click="saveConfig(0)"
    ...
    <el-card :bordered="false"
      ...
      <div class="diy-wrapper">
              ...
              <draggable class="dragArea list-group"
                ...
                <div class="list-group-item"
                  ...
                  <div>
                    ...
                    <span class="conter iconfont-diy"
                          :class="element.icon"></span>
          ...
          <div class="wrapper"
            ...
            <div class="link-item"
              ...
              <div class="acea-row row-between-wrapper">
                ...
                <span class="copy_btn"
                      @click="onCopy(item.example)">复制</span>
              </div>
        ...
        <div class="wrapper-con"
          ...
          <div class="acticons">
            <el-button class="bnt mb10"
                       @click="showTitle">页面设置</el-button>
            <span></span>
            <el-button class="bnt mb10"
                       @click="nameModal = true">另存模板</el-button>
            <span></span>
            <el-button class="bnt"
                       @click="reast">重置</el-button>
          </div>
          <div class="content">
            <div class="contxt"
                      ...
                      <div class="mConfig-item"
                        ...
                        <div class="delete-box">
                          <div class="handleType">
                            <el-tooltip content="删除当前模块"
                                        placement="top">
                              <div class="iconfont iconshanchu2"
                                   @click.stop="bindDelete(item, key)"></div>
                            </el-tooltip>

                            <div class="iconfont iconfuzhi"
                                 @click.stop="bindAddDom(item, 0, key)"></div>
                            <div class="iconfont iconshangyi"
                                 :class="key === 0 ? 'on' : ''"
                                 @click.stop="movePage(item, key, 1)"></div>
                            <div class="iconfont iconxiayi"
    ...
    <el-dialog :visible.sync="nameModal"
               width="470px"
               title="设置模版名称"
               :show-close="true">
      <el-input v-model="saveName"
                placeholder="请输入模版名称"></el-input>
      <span slot="footer"
            class="dialog-footer">
        <el-button @click="nameModal = false">取 消</el-button>
        <el-button type="primary"
                   @click="saveModal">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    arraySort () {
      ...
      console.log('左侧菜单---11', this.lConfig)
      ...
      console.log('左侧菜单---', this.leftMenu)
    },
    // toImage(val){
    ...
    getDefaultConfig () {
      getDiyInfo(this.pageId).then(({ data }) => {
        ...
        this.$store.commit('mobildConfig/showUpdata', data.info.isShow);
        this.$store.commit('mobildConfig/colorUpdata', data.info.isBgColor || 0);
        this.$store.commit('mobildConfig/picUpdata', data.info.isBgPic || 0);
        this.$store.commit('mobildConfig/pickerUpdata', data.info.colorPicker || '#f5f5f5');
        this.$store.commit('mobildConfig/radioUpdata', data.info.bgTabVal || 0);
        this.$store.commit('mobildConfig/picurlUpdata', data.info.bgPic || '');
