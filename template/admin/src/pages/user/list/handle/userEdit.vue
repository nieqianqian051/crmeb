<template>
  <div>
    <el-form ref="formItem" :rules="ruleValidate" :model="formItem" label-width="100px" @submit.native.prevent>
      <el-form-item label="用户ID：" v-if="formItem.userId">
        <el-input
          class="form-sty"
          disabled
      ...
      <el-form-item label="真实姓名：" prop="realName">
        <el-input
          class="form-sty"
          v-model.trim="formItem.realName"
          placeholder="请输入真实姓名"
          style="width: 80%"
        ></el-input>
      </el-form-item>
      <el-form-item label="手机号码：" prop="tel">
        <el-input class="form-sty" v-model="formItem.tel" placeholder="请输入手机号码" style="width: 80%"></el-input>
      </el-form-item>
...
<!--      </el-form-item>-->
      <el-form-item label="用户备注：">
        <el-input class="form-sty" v-model="formItem.address" placeholder="请输入用户备注" style="width: 80%"></el-input>
      </el-form-item>
  ...
  data() {
    return {
      ...
      ruleValidate: {
        ...
        truePwd: [{ required: true, message: ' ', trigger: 'blur' }],
      },
      dataLabel: [],
    };
  },
