...
export function editUser(data) {
  return request({
    url: '/user/user/edit/' + data.userId,
    method: 'post',
    data,
  });
}
 ...
 * 获取二维码
 */
export function getQrCode(uuId) {
  return request({
    url: `/user/user/recipe/${uuId}`,
    method: 'get',
 ...
 * 计算用户基础代谢
 */
export function userAdviceHeat(data) {
  return request({
    url: '/user/user/queryAdviceHeat',
    method: 'post',
    data,
  });
}
 ...
 * 搜索三餐食谱列表
 */
export function searchAllRecipe(data) {
  return request({
    url: '/user/user/recipe',
    method: 'get',
    params: data,
  });
}
 ...
 * 搜索主食列表
 */
export function searchAllMainFood(data) {
	return request({
	  url: '/user/user/mainFood',
	  method: 'get',
	  params: data,
	});
}
 ...
 * @param {Object} data
 */
export function treeRecipe(data, params) {
  return request({
    url: '/user/user/treeRecipe',
    method: 'post',
    data: data,
    params: params,
  });
...
export function getUserQrcode(id) {
	return request({
		url: `/system/user/getUserQrcode/${id}`,
		method: 'get',
		responseType: "arraybuffer",
	})
}