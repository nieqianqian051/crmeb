<template>
	<uni-popup ref="popup" background-color="#fff">
		<view class="chatWrap">
			<input type="text" v-model="chatContent" :placeholder="`评论:(${currentChat.name})`" class="inputWrap" />
			<image src="../static/images/user/add_emo.png" mode="" class="emoImg" @tap="showEmo"></image>
			<text class="sendText" @click="sendMes()">发送</text>
		</view>
...
<script>
	export default {
		...
		methods: {
			...
			sendMes() {
				console.log('发送---', this.chatContent)
				this.$emit('changeMsg', this.chatContent);
				this.chatContent = "";
			}
		}
	}
